...
namespace WaveBox.Server.Tests {
    internal static class TestPasswordWorkFactor {
        ...
        /// value is tuned to take a noticeable fraction of a second per hash, and the integration
        /// fixtures create a user per test method, so leaving it alone would dominate the run time.
        /// </summary>
        [ModuleInitializer]
