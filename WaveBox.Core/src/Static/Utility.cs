...
namespace WaveBox.Core.Static {
    public static class Utility {
        /// <summary>
        /// Generates a random string, for use in session creation. Random.Shared is thread-safe;
        /// a plain shared Random instance corrupts under concurrent use and this feeds session IDs.
        /// </summary>
