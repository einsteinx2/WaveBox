...
namespace WaveBox.Http
{
	public class HttpProcessor 
	{
		...
		public void sendBytes(byte[] bytes, int startOffset, long length)
		{
			...
			// Write the headers to output stream
			long contentLength = length - startOffset;
			HttpHeader h = new HttpHeader(HttpHeader.HttpStatusCode.OK, "", contentLength);
			h.WriteHeader(this);
